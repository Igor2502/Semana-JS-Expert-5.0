...
describe('#UploadHandler test suite', () => {
  ...
  describe('#registerEvents', () => {
    test('shold call onFile and onFinish functions on Busboy instance', () => {
  ...
  describe('#handleFileBytes', () => {
    ...
    test('given message timer delay as 2secs it should emit only two messages during 3secs period', async () => {
      jest.spyOn(ioObj, ioObj.emit.name)
